        ...
        if( isset($_POST['submit']) ){
            ...
            if($power == 'yes'){ //*************************
                ...
                if( isset($_FILES["profilePic"]["name"]) && !empty($_FILES["profilePic"]["name"]) ){
                    ...
                    $message_picture =  '<b class="text-danger">Пожалуйста, выберите фотографию профиля</b>';
                }
                ...
                <?php
                 ...
                 ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phoneId1" placeholder="Телефон" name="phone" class="form-control">
