            ...
            <div class="content-wrap">
                ...
                <?php
                 ...
                 ?>
                        ...
                        <h3>Обновить администратора</h3>

                        <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nameId">Полное имя</label>
                        <input type="text" id="nameId" placeholder="Полное имя" value="<?php if(isset($adminName)) echo $adminName; ?>" name="fullname" class="form-control" title="Только буквы и пробелы" pattern="[A-Za-z/\s]+">
                    ...
                    <div class="form-group">                    
                       <label>Тип администратора</label>
                        ...
                        <option <?php if($adminType == 'yes') { ?> selected <?php } ?> value="yes" >Главный администратор</option>
                        
                        <option <?php if($adminType == 'no') { ?> selected <?php } ?> value="no">Обычный администратор</option>
